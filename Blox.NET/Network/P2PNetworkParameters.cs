...
namespace Bitcoin.Blox.Network
{
	public class P2PNetworkParameters
	{
		...
		public static readonly String[] DNSSeedHosts = { "seed.bitcoin.sipa.be", "dnsseed.bitcoin.dashjr.org", "bitseed.xf2.org", "dnsseed.bluematt.me" }; //in future Blox will also have it's own dns responder
		...
		private static readonly String _BloxVersionString = "0.0.0.0";
		private static readonly String _BloxCodenameString = "Thashiznets-Testing";
		public static readonly String UserAgentString = @"/Blox.NET:" + _BloxVersionString + @"/" + _BloxCodenameString + @"/";
